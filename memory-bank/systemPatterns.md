...
## Data Management
- **Shadow Database:** A local SQLite database manages all application metadata (media clip details, tags, sequences, etc.).
...
- **Local Storage:** All application state, proxy files, and the SQLite database are managed within `.sceneflow` directories.
